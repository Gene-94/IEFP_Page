...
<div class="flex flex-col md:flex-row grid grid-cols-6 gap-2">
    <div class="flex-1 w-full mx-2 col-span-2">
    ...
    <div class="flex-1 w-full mx-2 col-span-2 ml-6">
        <div class="h-6 mt-3 text-xs font-bold leading-8 text-gray-600 uppercase"> Codigo Postal da Empresa</div>
        <div class="flex p-1 my-2 bg-white border border-gray-200 rounded ">
