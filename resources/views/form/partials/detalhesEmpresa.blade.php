<div class="flex flex-col md:flex-row">
    <div class="flex-1 w-full mx-2 ">
        ...
        <div class="flex p-1 my-2 bg-white border border-gray-200 rounded ">
            ...
            data-formulario="nomeEmpresa" class="w-full p-1 px-2 text-gray-800 outline-none appearance-none" >
        </div>
...
<div class="flex flex-col sm:flex-row">
    ...
    <div class="flex-1 w-full mx-2">
        ...
        <div class="flex p-1 my-2 bg-white border border-gray-200 rounded ">
            ...
            data-formulario="nifEmpresa" class="w-full p-1 px-2 text-gray-800 outline-none appearance-none">
        </div>
        <p class="hidden text-sm text-red-600" data-invalid="nifEmpresa">*Insira a morada do seu local de trabalho</p>
    </div>
    <div class="flex-1 w-full mx-2">
