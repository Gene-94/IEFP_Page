<div class="inicial fade" data-layout="formSection">
    ...
    <div class="w-full flex-1 mx-2 ">
        <div class="bg-white my-2 p-1 flex border border-gray-200 rounded ">
            <select name="habilitacoes" data-formulario="habilitacoes" onblur="validateField('habilitacoes')" required
    ...
    <div class="flex flex-col md:flex-row">
        <div class="w-full mx-2 flex-1 ">
            ...
            <div class="bg-white my-2 p-1 flex border border-gray-200 rounded ">
                <input placeholder="ex: Gestão" maxlength="250"
    ...
    <div class="flex flex-col md:flex-row">
        <div class="w-full flex-1 mx-2 ">
            ...
            <div class="datepicker bg-white my-2 p-1 flex border border-gray-200 rounded "
                ...
                <input type="file" name="certificado" accept=".pdf, .jpg, .jpeg, .png" required data-formulario="certificado" onblur="validateField('certificado')" onchange="validateField('certificado')"
                    class="form-control block p-1 px-2 appearance-none outline-none w-full text-gray-800 rounded">
            </div>
            <p class="hidden text-sm text-red-600" data-invalid="certificado">*Adicione um documento que comprove o seu nivel de escolaridade, tal como um certificado de habilitações, se não possuir um em formato digital pode tirar uma foto do mesmo. Em ultimo caso pode enviar uma copia da matricula.</p>
        </div>
